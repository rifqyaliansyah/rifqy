...
const items = [
    {
        ...
        place: 'PT. Nama Perusahaan',
        type: 'Magang',
        desc: 'Membangun UI komponen menggunakan Vue.js dan Tailwind CSS, berkontribusi pada dashboard internal perusahaan.',
    ...
    },
    {
        ...
        place: 'Self-employed',
        type: 'Freelance',
        desc: 'Mengerjakan berbagai proyek website untuk klien lokal — landing page, company profile, hingga toko online sederhana.',
        tags: ['Nuxt', 'WordPress', 'CSS'],
    },
    {
        year: '2023',
        side: 'left',
        ...
        place: 'PT. Nama Lain',
        type: 'Kerja',
        desc: 'Bertanggung jawab atas pengembangan fitur baru dan maintenance aplikasi web skala menengah.',
        tags: ['Vue', 'Node.js', 'PostgreSQL'],
    },
    {
        year: '2024',
        side: 'right',
        role: 'Project: Portfolio v1',
        place: 'Personal Project',
        type: 'Project',
        desc: 'Merancang dan membangun portfolio pribadi dengan animasi canvas, cursor custom, dan efek CRT.',
        tags: ['Nuxt', 'Canvas API', 'Motion'],
    },
]
