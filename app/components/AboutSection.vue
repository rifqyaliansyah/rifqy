    ...
    <section id="about" class="about">
        <div class="about-inner">
            ...
            <div class="about-stats">
                <Motion v-for="(stat, i) in stats" :key="stat.value" class="stat-item" :initial="{ opacity: 0, y: 20 }"
...
.stat-item {
    ...
    gap: 0.35rem;
    padding: 0 1.5rem;
    border-right: 0.5px solid #ddd8cf;
}
